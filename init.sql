...
ombre\ VARCHAR(100) NOT NULL,
  ...
  \
ol\ ENUM('ADMIN', 'CLIENTE') NOT NULL DEFAULT 'CLIENTE',
  PRIMARY KEY (\id\)
...
CREATE TABLE IF NOT EXISTS \Ticket\ (
  \id\ BIGINT NOT NULL AUTO_INCREMENT,
  \echa_compra\ DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  \codigo\ VARCHAR(100) NOT NULL UNIQUE,
  \estado\ ENUM('PENDIENTE', 'PAGADO', 'CANCELADO') NOT NULL DEFAULT 'PENDIENTE',
  \usuario_id\ BIGINT NOT NULL,
  \uncion_id\ BIGINT NOT NULL,
  PRIMARY KEY (\id\),
  INDEX \idx_ticket_usuario\ (\usuario_id\),
  INDEX \idx_ticket_funcion\ (\uncion_id\),
  CONSTRAINT \k_ticket_usuario\
    FOREIGN KEY (\usuario_id\) REFERENCES \Usuario\ (\id\)
    ON DELETE RESTRICT
    ON UPDATE CASCADE,
  CONSTRAINT \k_ticket_funcion\
    FOREIGN KEY (\uncion_id\) REFERENCES \Funcion\ (\id\)
    ON DELETE RESTRICT
    ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS \Pago\ (
  ...
  \echa_pago\ DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  \	icket_id\ BIGINT NOT NULL,
  PRIMARY KEY (\id\),
  INDEX \idx_pago_ticket\ (\	icket_id\),
  CONSTRAINT \k_pago_ticket\
    FOREIGN KEY (\	icket_id\) REFERENCES \Ticket\ (\id\)
    ON DELETE CASCADE
    ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO \Pelicula\ (\id\, \	itulo\, \descripcion\, \genero\, \duracion\, \clasificacion\, \imagen\) VALUES
...
INSERT INTO \Funcion\ (\id\, \echa\, \hora\, \sala\, \entradas_disponibles\, \precio\, \pelicula_id\) VALUES
...
INSERT INTO \Ticket\ (\id\, \echa_compra\, \codigo\, \estado\, \usuario_id\, \uncion_id\) VALUES
(1, DATE_SUB(NOW(), INTERVAL 2 HOUR), 'PLP-2026-0001', 'PAGADO', 2, 1),
(2, DATE_SUB(NOW(), INTERVAL 1 HOUR), 'PLP-2026-0002', 'PAGADO', 3, 3);

INSERT INTO \Pago\ (\id\, \monto\, \metodo\, \estado\, \echa_pago\, \	icket_id\) VALUES
